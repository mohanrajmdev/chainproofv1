window.CONTRACT = {
  address: "0x2b95497F17134b3529c67F4438B05c964fD4eF9d",
      ...
      .catch(function (err) {
        ...
        Certificate not Verified 😕
         ...
         <i class="text-info fa fa-check-circle" aria-hidden="true"></i>
          ...
          $("#college-name").html(
            `<span class="text-info"><i class="fa-solid fa-graduation-cap"></i></span> ${window.info}`
          );
          ...
          $("#blockNumber").html(
            `<span class="text-info"><i class="fa-solid fa-cube"></i></span> ${blockno}`
          );
